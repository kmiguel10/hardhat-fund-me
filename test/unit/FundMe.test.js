...
//Only run test if we are on a deve environment - unit tests only runs on dev chains
    ...
    : describe("FundMe", function () {
          ...
          describe("fund", async function () {
              ...
              it("updates the amount funded data structure", async function () {
                  ...
                  const response = await fundMe.getAddressToAmountFunder(
                      deployer
                  )
          ...
          describe("withdraw", async function () {
              ...
              it("allows us to withdraw with multiple s_funders", async function () {
                  ...
                  for (i = 1; i < 6; i++) {
                      assert.equal(
                          await fundMe.getAddressToAmountFunder(
                              accounts[i].address
                          ),
                          0
                      )
